...
## AI工具
优先推荐使用ChatGPT和Gemini练习口语对话,网络不好的话推荐豆包~~deepseek~~

[Chatgpt](AI/Chatgpt.md): 学语法练口语都可以.

[Gemini](AI/Gemini.md): 学语法练口语都可以.

[豆包](AI/豆包.md): 无需翻墙,支持日语语音对话了,但是感觉训练的日语材料不多，有点傻.
...
[illa-helper](AI/illa.md):开源免费的,需要你有自己的api key,和vocabmeld差不多的原理.  

[日本語文章解析器](AI/analyse.md): 开源免费的,需要你有自己的api key,句子语法分析器，可以翻译句子，分析句子使用到的语法点，词性，以及每个词的含义，作用。
